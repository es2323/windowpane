        ...
        <div class="right-column">
          ...
          <div v-if="activeSection === 'contact'" class="content-section fade-in visible">
            <div class="contact-content centered-links">
              <a href="mailto:enoshsolomonn@gmail.com" target="_blank">
                <!-- Email Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                <span>Email</span>
              </a>

              <a href="https://www.linkedin.com/in/enosh-solomon-3370321bb/" target="_blank">
                <!-- LinkedIn Icon -->
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  width="20" 
              ...
              <a href="https://github.com/es2323" target="_blank">
                <!-- GitHub Icon -->
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  width="20" 
...
.contact-content.centered-links a {
  /* Flexbox is the key to alignment */
  display: inline-flex;
  align-items: center;
  gap: 0.3rem; /* This creates a space between the icon and the text */
